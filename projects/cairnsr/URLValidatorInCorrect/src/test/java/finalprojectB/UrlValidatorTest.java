...
public class UrlValidatorTest extends TestCase {
   ...
   public void testManualTest()
   {
       ...
       assertEquals(true, "http://foo.com/blah_blah");
       assertEquals(true, "http://userid:password@example.com:8080");
       assertEquals(true, "http://⌘.ws");
       assertEquals(false, "http://../");
       assertEquals(false, "http://foo.bar?q=Spaces should be encoded");
       assertEquals(false, "///a");
       assertEquals(false, "http:///a");
